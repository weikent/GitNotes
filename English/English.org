...
都表示喜欢干什么
** like + to 表达的是一个特殊情况
i like to play football in my free time with my friends.
可以理解为某次空闲时间喜欢和朋友踢足球，另一次空闲时间就喜欢干别的。
** like + ing 表达的是一个普遍情况
i like playing football in my free time with my friends.
可以理解为任何空闲时间都喜欢和朋友踢足球。


* will 和 be going to

** 使用 be going to
- if we have a plan, ambition or intention to do something in the furture we use ' be going to '
- If we decided to do something of arranged to do something in the near future, we use 'be going to'

** 使用 will
- We use the Future Simple Tense when we make predictions about the future with the verbs 'expect, think, belivev,etc'

* 一般过去时 和 过去完成式  和 现在完成时

** 使用一般过去时
- If an action happened at a definite time in the past time, we use the Past simple Tense


* 一般现在时
When we talk about things in general, permanent situations and states or things that happen sometimes, we alway use the 一般现在时

* we should remember  that some adjectives are used with specific prepositions after.
